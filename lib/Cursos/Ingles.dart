...
import 'package:guia5/Preguntas/PreguntasEng/Sesion1Eng.dart';
import 'package:guia5/Preguntas/PreguntasEng/Sesion2Eng.dart';
import 'package:guia5/Preguntas/PreguntasEng/Sesion3Eng.dart';
import 'package:guia5/Preguntas/PreguntasEng/Sesion4Eng.dart';
import 'package:guia5/Preguntas/PreguntasEng/Sesion5Eng.dart';
...
void main() => runApp(Ingles());

class Ingles extends StatelessWidget {
  @override
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8),
          Text(
            'El curso de Inlgés tiene como objetivo principal desarrollar competencias linguísticas y habilidades prácticas en los estudiantes, preparándolos para enfrentar los desafíos del mundo del trabajo. El curso busca fomentar la responsabilidad, la ética profesional y la capacidad de trabajar en equipo, así como proporcionar una comprensión de los derechos y deberes laborales.',
